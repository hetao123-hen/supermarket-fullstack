...
export default function Sidebar({ currentView, onNavigate, onExport, onImport }) {
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        ...
        <span className="sidebar-brand">SuperBase</span>
      </div>
      ...
      <nav className="sidebar-nav">
        ...
        <button
          className={`sidebar-item ${currentView === 'inventory' ? 'active' : ''}`}
      ...
      <div className="sidebar-footer">
        <button className="sidebar-footer-item" onClick={onExport} title="Export data to JSON file">
          {ICONS.download}
          Export Data
        </button>
        <button className="sidebar-footer-item" onClick={onImport} title="Import data from JSON file">
          {ICONS.upload}
          Import Data
        </button>
      </div>
